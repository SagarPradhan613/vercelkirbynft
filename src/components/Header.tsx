                    ...
                    <div className="rightLinkContainer">
                        ...
                        {address ?
                            <div onClick={() => disconnect?.disconnect()}>
                                <div className="bg-[#FF720D] connect flex justify-center items-center py-2 px-8 text-white font-bold text-lg rounded-[19.5px]">{address.slice(0, 4)}...{address.slice(-4)}</div>
                            </div>
                            :
