    ...
    return (
        ...
        <>
            <div className="MainHeaderContainer bg-[#1E2B45]">
                ...
                <div className="HeaderRightPortion">
                    <div className="rightLinkContainer">
                        ...
                        <p className="text-white font-bold text-lg">BNB Smart Chain</p>
                            <svg width="20" height="13" viewBox="0 0 20 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18 2L9.99912 10.0009L1.99995 2.0017" stroke="white" stroke-width="3" />
                            </svg>
                        </div>
                        <div>
                            <div className="bg-[#FF720D] flex justify-center items-center py-2 px-8 text-white font-bold text-lg rounded-[19.5px]">Connect Wallet</div>
                        </div>
                    </div>
                </div>
            </div>
