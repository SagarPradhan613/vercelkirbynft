  ...
  return (
    <div>
            ...
            <div>
              <div className="flex mt-10 lg:mt-0 lg:flex-row flex-col gap-3 lg:gap-4 w-full">
                <div className="lg:w-[60%] w-full p-2 bg-[#121d32] rounded-[20px] flex items-center justify-between ">
                  <button type="button" onClick={decrementMint} className="bg-[#1E2B45]  rounded-[20px] dec w-[20%] h-[50px] flex justify-center  items-center ">
                  ...
                  <button type="button"
                    onClick={incrementMint} className="bg-[#1E2B45] inc w-[20%] h-[50px] rounded-[20px] flex justify-center items-center ">
      ...
      <div className="mt-10 pb-20 md:pb-0 social-container gap-8 flex w-full justify-center items-center">
        <a href="https://t.me/bluekirbyftm" className="hover:scale-125 transition-all duration-500 ease-in-out" target="_blank">
        ...
        <a href="https://twitter.com/Bluekirbyftm" className="hover:scale-125 transition-all duration-500 ease-in-out" target="_blank">
        ...
        <a href="https://ftmscan.com/token/0x97bdAfe3830734acF12Da25359674277fcc33729" className="hover:scale-125 transition-all duration-500 ease-in-out" target="_blank">
